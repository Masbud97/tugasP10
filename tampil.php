...
<head>
    <title>Form Input Data | PHP MySQL Tutorial</title>
...
<form action="action-input-data.php" method="POST" name="form-input-data">
    <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr height="46">
            <td> </td>
            <td>NPM</td>
            <td><input type="text" name="NPM" size="35" maxlength="10" /></td>
        </tr>
        <tr height="46">
            <td> </td>
            <td>Nama</td>
        ...
        <tr height="46">
            <td> </td>
            <td>kelas</td>
            <td><input type="text" name="kelas" size="50" maxlenght="30" /></td>
        </tr>    
            <tr height="46">
            <td> </td>
            <td>Jurusan</td>
